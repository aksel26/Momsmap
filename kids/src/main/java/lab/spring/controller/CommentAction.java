		...
		try {
			BufferedWriter fw = new BufferedWriter(
					new OutputStreamWriter(
							...
							new FileOutputStream("/Users/hxmkim/Documents/kids/kids/src/main/webapp/resources/images/worddata5.csv"),"utf-8"));
...
public HashMap<String, Integer> wordCount(List<CommentVO> ls) {
		...
		try{
            ...
            File file = new File("/Users/hxmkim/Documents/kids/kids/words.txt");
            //입력 스트림 생성
